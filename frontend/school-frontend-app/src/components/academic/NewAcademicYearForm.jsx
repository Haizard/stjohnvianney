...
const NewAcademicYearForm = ({ open, onClose, onSubmit, academicYear }) => {
        ...
        <DialogContent>
          ...
          <Box sx={{ mt: 4, mb: 2 }}>
            ...
            {formData.terms.map((term, index) => (
              <Box key={`term-${index}-${Date.now()}`} sx={{ mt: 2, p: 2, border: '1px solid #e0e0e0', borderRadius: 1 }}>
...
NewAcademicYearForm.defaultProps = {
  academicYear: null
};
